...
if (userChoice1 === true) {
    var directionChoice1 = prompt("You woke up alone. Nothing but the vast forest that seemed to extend for miles. Man. You sure screwed up this time. What did you do? Did you [go north], [go west], [go south], or [go east]?"); //The correct direction will be "go left"
}
if (directionChoice1 === "go north") {
...
if (directionChoice1 === "go east")  {
    
}
if (directoncChoice1 === "go west") {
